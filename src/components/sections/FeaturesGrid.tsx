        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((f, i) => (
            <Reveal key={f.title} delay={(i % 3) * 0.07}>
              <div className="signal-border card-sheen group flex h-full flex-col gap-3.5 rounded-2xl border border-border bg-surface/40 p-6 transition-colors hover:border-border-strong">
