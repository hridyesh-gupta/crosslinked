...
export function ServiceItemCard({ service }: { service: Service }) {
  return (
    <div className="card-sheen group flex h-full flex-col gap-3 rounded-2xl border border-border bg-surface/40 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:bg-surface">
