...
export function ServiceCategoryCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "signal-border card-sheen group relative flex flex-col gap-4 rounded-2xl border border-border bg-surface/50 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:bg-surface",
        className,
      )}
    >
